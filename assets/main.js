(() => {
  ...
  document.addEventListener("click", (event) => {
    if (event.target.classList.contains("link-item")) {
      /* make sure event.target.hash has a value before overridding defaul
      behavior */
      if (event.target.hash !== "") {
        //prevent defaaul anchoc click behavior
        event.preventDefault();
        const hash = event.target.hash;
        //deactivate existeng active section
        document.querySelector(".section.active").classList.add("hide");
        document.querySelector(".section.active").classList.remove("active");
        //activate new section
        document.querySelector(hash).classList.add("active");
        document.querySelector(hash).classList.remove("hide");
        //deactive existen active navigation menu
        ...
        navItems.forEach((item) => {
          if (hash === item.hash) {
            //activate new navig menu 'link-item'
...
(() => {
  ...
  function popupDetails() {
    // if dont have details the portfolio
...
//----- hide all section execept active -------
